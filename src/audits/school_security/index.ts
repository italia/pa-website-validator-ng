...
class SchoolSecurityAudit extends SecurityAudit {
    ...
    async returnGlobalHTML() {
        ...
        const reportHtml = await ejs.renderFile('src/audits/school_security/template.ejs', { ...await this.meta(), code: this.code, table: this.globalResults, status, statusMessage: message, metrics: null ,  totalPercentage : null });
        return reportHtml
    }
}
