...
class SchoolLicenceAudit extends LicenceAudit {
    ...
    async returnGlobalHTML() {
        ...
        const reportHtml = await ejs.renderFile('src/audits/school_license/template.ejs', { ...await this.meta(), code: this.code, table: this.globalResults, status, statusMessage: message, metrics: null ,  totalPercentage : null });
        return reportHtml
    }
