...
class SchoolInformativeAccAudit extends InformativeAccAudit {
  auditId = "school-informative-legislation-accessibility-declaration-is-present";
  auditData = auditDictionary["school-informative-legislation-accessibility-declaration-is-present"];
